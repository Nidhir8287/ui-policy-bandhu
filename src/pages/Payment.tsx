...
import { getUserProfile } from '../../api/userProfile'; // Adjust the import path as needed
...
function Payment() {
  ...
  return (
    <div className="min-h-screen bg-[#F3F3FF]">
      <Header />
      {!pending_subscription ? <div className="flex justify-center gap-28 px-11 py-12">
        <div>
      ...
      <div className='flex items-center justify-center h-screen gap-28'>
        <div className='flex flex-col gap-10 max-w-[400px]'>
            <span className='text-6xl text-[#7979DC]'>
                Congratulations
            </span>
